...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            if (remoteMessage.getNotification().getTitle().contains("Join")) {
                ...
                intent.setAction("com.google.firebase.quickstart.fcm.onMessageReceived");
                sendBroadcast(intent);
            } else if (remoteMessage.getNotification().getTitle().contains("Disband")) {
                sendNotification(remoteMessage.getNotification().getBody());
                String test = remoteMessage.getNotification().getBody();
                Intent intent = new Intent();
                intent.putExtra("type", "Disband");
                intent.putExtra("name", "Dummy");
                intent.setAction("com.google.firebase.quickstart.fcm.onMessageReceived");
                sendBroadcast(intent);
            } else if (remoteMessage.getNotification().getTitle().contains("Start")) {
                sendNotification(remoteMessage.getNotification().getBody());
                String test = remoteMessage.getNotification().getBody();
                Intent intent = new Intent();
    ...
    private void sendNotification(String messageBody) {
        final Intent notificationIntent = new Intent(getApplicationContext(), GameActivity.class);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(R.drawable.ic_ezr)
                .setContentTitle("EmaZing Race")
